    ...
    <>
        ...
        {open && (
          <div className="fixed inset-0 h-screen z-50 overflow-auto">
            ...
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="max-w-5xl mx-auto bg-black h-fit z-[60] my-10 p-4 rounded-3xl relative"
            >
              <button
      ...
      >
        <div className="relative z-40 p-8">
          ...
          <p className="text-white text-xl font-semibold mt-2">{card.title}</p>
        </div>
        <video
          className="absolute z-10 inset-0 w-full h-full object-cover rounded-3xl"
          src={card.src}
          muted
        />
      </motion.button>
